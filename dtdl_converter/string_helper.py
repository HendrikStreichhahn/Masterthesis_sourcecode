...
def get_abs_path(path, rel_base = os.getcwd()):
    print(f"get_abs_path('{path}', '{rel_base}')")
...
# def change_path_base(path: str, old_path_base: str, new_path_base: str):
#     # Get the absolute paths of A, B, and C
#     abs_path_a = os.path.abspath(path)
#     abs_path_b = os.path.abspath(old_path_base)
#     abs_path_c = os.path.abspath(new_path_base)

#     # Calculate the relative path from A to B
#     rel_path_ab = os.path.relpath(abs_path_a, abs_path_b)

#     # Calculate the absolute path relative to C
#     abs_path_ac = os.path.join(abs_path_c, rel_path_ab)
